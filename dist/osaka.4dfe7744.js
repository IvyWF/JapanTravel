...
var amountToScroll = galleryWidth - window.innerWidth + 100;
...
window.addEventListener("mousemove", function (event) {
  ...
  _gsap.default.to(".galleryTwo img", {
...
function animate() {
  ...
  canvas.style.transform = "translate3d(".concat(currentX - width / 2, "px, ").concat(currentY - height * 0.8, "px, 0)");
  drawImage(imgIndex);
...
},{}]},{},["../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","scripts/osaka.js"], null)
//# sourceMappingURL=/osaka.4dfe7744.js.map