...
//Cursor Effect
var firstBall = document.querySelector('.cursor__ball--first');
var secondBall = document.querySelector('.cursor__ball--second');
...
function onMouseMove(e) {
  _gsap.default.to(firstBall, {
    x: e.clientX - 15,
    y: e.clientY - 15,
    duration: 0.4
  });
  _gsap.default.to(secondBall, {
    x: e.clientX - 5,
    y: e.clientY - 7,
    duration: 0.1
  });
