...
},{"./Observer.js":"node_modules/gsap/Observer.js"}],"node_modules/@studio-freight/lenis/dist/lenis.mjs":[function(require,module,exports) {
"use strict";
...
function t(t, i) {
  for (var e = 0; e < i.length; e++) {
    var o = i[e];
    o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(t, "symbol" == typeof (n = function (t, i) {
...
function i(i, e, o) {
  return e && t(i.prototype, e), o && t(i, o), Object.defineProperty(i, "prototype", {
    writable: !1
  }), i;
}
function e() {
...
var n = /*#__PURE__*/function () {
    ...
    return i.advance = function (t) {
      ...
      if (this.isRunning) {
        ...
        null == (i = this.onUpdate) || i.call(this, this.value, r), r && this.stop();
      }
    }, i.stop = function () {
      this.isRunning = !1;
      ...
      var o = e.lerp,
        ...
        a = e.onStart,
        c = e.onUpdate;
      this.from = this.value = t, this.to = i, this.lerp = n, this.duration = r, this.easing = h, this.currentTime = 0, this.isRunning = !0, null == a || a(), this.onUpdate = c;
    }, t;
  }(),
  s = /*#__PURE__*/function () {
    function t(t) {
    ...
    function t(t, i) {
      ...
      this.onTouchStart = function (t) {
        var i = t.targetTouches ? t.targetTouches[0] : t,
          o = i.clientY;
        e.touchStart.x = i.clientX, e.touchStart.y = o, e.lastDelta = {
          x: 0,
          y: 0
        };
        ...
        var i = t.targetTouches ? t.targetTouches[0] : t,
          o = i.clientX,
          n = i.clientY,
          s = -(o - e.touchStart.x) * e.touchMultiplier,
          r = -(n - e.touchStart.y) * e.touchMultiplier;
        e.touchStart.x = o, e.touchStart.y = n, e.lastDelta = {
          x: s,
          y: r
        }, e.emitter.emit("scroll", {
          deltaX: s,
          deltaY: r,
          event: t
        });
        ...
        e.emitter.emit("scroll", {
          deltaX: e.lastDelta.x,
          deltaY: e.lastDelta.y,
          event: t
        });
    ...
    function t(t) {
      ...
      this.onVirtualScroll = function (t) {
        ...
        if (!s.ctrlKey) {
          ...
          if (!("both" === i.options.gestureOrientation && 0 === o && 0 === n || "vertical" === i.options.gestureOrientation && 0 === n || "horizontal" === i.options.gestureOrientation && 0 === o || r && "vertical" === i.options.gestureOrientation && 0 === i.scroll && !i.options.infinite && n <= 0)) {
            ...
            if (!(h = h.slice(0, h.indexOf(i.rootElement))).find(function (t) {
              ...
              var c = r && i.options.syncTouch,
                u = r && "touchend" === s.type && Math.abs(a) > 1;
              u && (a = i.velocity * i.options.touchInertiaMultiplier), i.scrollTo(i.targetScroll + a, e({
                programmatic: !1
              }, c && {
      ...
      if (!this.isStopped && !this.isLocked || void 0 !== y && y) {
        ...
        if ("number" == typeof t) {
          ...
          this.animate.fromTo(this.animatedScroll, t, {
            ...
            lerp: f,
            onStart: function () {
              c && (e.isLocked = !0), e.isScrolling = !0;
            },
            onUpdate: function (t, i) {
              e.isScrolling = !0, e.velocity = t - e.animatedScroll, e.direction = Math.sign(e.velocity), e.animatedScroll = t, e.setScroll(e.scroll), T && (e.targetScroll = t), i || e.emit(), i && requestAnimationFrame(function () {
                e.reset(), e.emit(), null == S || S(e);
              });
            }
          });
        }
      }
    }, h.toggleClass = function (t, i) {
...
exports.default = h;
},{}],"images/konnichiwa/slider3/1.png":[function(require,module,exports) {
module.exports = "/1.4d59e181.png";
},{}],"images/konnichiwa/slider3/2.png":[function(require,module,exports) {
module.exports = "/2.ff2d8932.png";
},{}],"images/konnichiwa/slider3/3.png":[function(require,module,exports) {
module.exports = "/3.a9f3c801.png";
},{}],"images/konnichiwa/slider3/4.png":[function(require,module,exports) {
module.exports = "/4.d7ed5b0e.png";
},{}],"images/konnichiwa/slider3/5.png":[function(require,module,exports) {
module.exports = "/5.412c3c3a.png";
},{}],"images/konnichiwa/slider3/6.png":[function(require,module,exports) {
module.exports = "/6.87bb1ccf.png";
},{}],"scripts/sliders2.js":[function(require,module,exports) {
"use strict";

var _gsap = _interopRequireDefault(require("gsap"));
var _ScrollTrigger = require("gsap/ScrollTrigger");
var _lenis = _interopRequireDefault(require("@studio-freight/lenis"));
var _ = _interopRequireDefault(require("../images/konnichiwa/slider3/1.png"));
var _2 = _interopRequireDefault(require("../images/konnichiwa/slider3/2.png"));
var _3 = _interopRequireDefault(require("../images/konnichiwa/slider3/3.png"));
var _4 = _interopRequireDefault(require("../images/konnichiwa/slider3/4.png"));
var _5 = _interopRequireDefault(require("../images/konnichiwa/slider3/5.png"));
var _6 = _interopRequireDefault(require("../images/konnichiwa/slider3/6.png"));
...
animate();
},{"gsap":"node_modules/gsap/index.js","gsap/ScrollTrigger":"node_modules/gsap/ScrollTrigger.js","@studio-freight/lenis":"node_modules/@studio-freight/lenis/dist/lenis.mjs","../images/konnichiwa/slider3/1.png":"images/konnichiwa/slider3/1.png","../images/konnichiwa/slider3/2.png":"images/konnichiwa/slider3/2.png","../images/konnichiwa/slider3/3.png":"images/konnichiwa/slider3/3.png","../images/konnichiwa/slider3/4.png":"images/konnichiwa/slider3/4.png","../images/konnichiwa/slider3/5.png":"images/konnichiwa/slider3/5.png","../images/konnichiwa/slider3/6.png":"images/konnichiwa/slider3/6.png"}],"../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","scripts/sliders2.js"], null)
//# sourceMappingURL=/sliders2.1b09475f.js.map