...
},{"./gsap-core.js":"node_modules/gsap/gsap-core.js","./CSSPlugin.js":"node_modules/gsap/CSSPlugin.js"}],"scripts/fullscreenMenu2.js":[function(require,module,exports) {
"use strict";
...
function removePC() {
  var parentOne = document.getElementById('header-container');
  var childOne = document.getElementById('nav-toggle-btn');
  var parentTwo = document.getElementById('container');
  var childTwo = document.getElementById('navContainer');
  if (matchPc.matches) {
...
function removeTabletMobile() {
  var parentThree = document.getElementById('header-container');
  var childThree = document.getElementById('headerNav');
  var childFour = document.getElementById('dateTime');
  var childFive = document.getElementById('japanese');
  var parentFour = document.getElementById('removeSmallParent');
  var childSix = document.getElementById('removeSmallOne');
  var childSeven = document.getElementById('removeSmallTwo');
...
var bar = _gsap.default.timeline();
bar.to('.bar-1', {
  duration: 0.5,
  attr: {
    d: "M8,2 L2,8"
...
},{}]},{},["../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","scripts/fullscreenMenu2.js"], null)
//# sourceMappingURL=/fullscreenMenu2.6870831d.js.map